export default function Page() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="px-4 py-16 md:py-24 lg:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10">
            <a
              href="#proof"
              className="inline-block rounded-lg bg-blue-600 px-8 py-3 text-base font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
            >
              See It In Action
            </a>
          </div>
      ...
      {/* Features Section */}
      <section className="bg-gray-50 px-4 py-16 md:py-24" aria-labelledby="features-heading">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            <figure className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
              ...
              />
              <figcaption className="mt-4 text-center text-sm leading-relaxed text-gray-600">
      ...
      {/* Pricing Section */}
      <section className="bg-gray-50 px-4 py-16 md:py-24" aria-labelledby="pricing-heading">
        <div className="mx-auto max-w-4xl text-center">
          <h2 id="pricing-heading" className="text-balance text-3xl font-bold md:text-4xl">
            Pricing
          </h2>
          <div className="mt-12 rounded-lg border-2 border-dashed border-gray-300 bg-white px-8 py-16">
